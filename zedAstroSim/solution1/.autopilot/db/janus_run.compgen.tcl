...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_int_out \
    op interface \
    ports { p_int_out_address0 { O 6 vector } p_int_out_ce0 { O 1 bit } p_int_out_we0 { O 1 bit } p_int_out_d0 { O 64 vector } p_int_out_address1 { O 6 vector } p_int_out_ce1 { O 1 bit } p_int_out_we1 { O 1 bit } p_int_out_d1 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'p_int_out'"
}
}
