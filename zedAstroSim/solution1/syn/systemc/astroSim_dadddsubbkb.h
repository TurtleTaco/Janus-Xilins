...
#ifndef __astroSim_dadddsubbkb__HH__
#define __astroSim_dadddsubbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dadddsubbkb) {
    ...
    SC_CTOR(astroSim_dadddsubbkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
